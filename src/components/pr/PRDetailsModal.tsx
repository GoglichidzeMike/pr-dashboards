...
import { ExternalLink, GitBranch, MessageSquare, FileText, Clock } from 'lucide-react';
import { usePRDetails, PRDetails } from '@/lib/hooks/usePRDetails';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        {loading && !prDetails ? (
          ...
          <div className="flex-1 overflow-y-auto text-center py-8 text-destructive">
          ...
          <Tabs defaultValue="description" className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-1 overflow-y-auto mt-4">
              ...
              <TabsContent value="comments" className="mt-0">
                <PRComments comments={prDetails.comments.nodes} />
              </TabsContent>
              <TabsContent value="files" className="mt-0">
                <PRFiles files={prDetails.files.nodes} />
              </TabsContent>
